...
interface SafecoinWallet {
    postMessage(...args: unknown[]): unknown;
}

interface SafecoinWindow extends Window {
    sollet?: SafecoinWallet;
}

declare const window: SafecoinWindow;

export interface SafecoinWalletAdapterConfig {
    provider?: string | SafecoinWallet;
    network?: WalletAdapterNetwork;
    pollInterval?: number;
    pollCount?: number;
}

export class SafecoinWalletAdapter extends BaseMessageSignerWalletAdapter {
    private _provider: string | SafecoinWallet | undefined;
    private _network: WalletAdapterNetwork;
    private _connecting: boolean;
    private _wallet: Wallet | null;

    constructor(config: SafecoinWalletAdapterConfig = {}) {
        super();
